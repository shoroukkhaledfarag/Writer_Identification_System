...
-main folder variable :has to be 'data' only not the complete path
 and the folder must be in the same directory of the notebook.
...
to the function and the folder must be in the same directory of 
the notebook.

-value 'performance' is the second variable to the function
